...
class PDBParser(Parser):
    ...
    def parse_file(self, filename):
        """Extract metadata. See :meth:`Parser.parse_file` for details.
           ...
           file is assumed to derive from a given PDB ID or a comparative model
           available at a given DOI. ``TITLE`` records are expected to describe
           ...
           about the comparative modeling templates used and their alignment.
