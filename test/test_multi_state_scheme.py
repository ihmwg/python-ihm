...
class Tests(unittest.TestCase):
    ...
    def test_multistatescheme_init(self):
        ...
        class MockObject(object):
            pass
        mssc1 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s1',
                                                                    end_state='s2')
        ...
        mss2 = ihm.multi_state_scheme.MultiStateScheme(name='n2',
                                                    details='d2',
    ...
    def test_multistatescheme_add_connectivity(self):
        ...
        ## Add a connectivity should add it to the connectivity_list and the states should be stored as well
        mssc1 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s1',
                                                                    end_state='s2')
        ...
        mssc2 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s3')
        mss1.add_connectivity(mssc2)
        self.assertEqual(len(mss1.connectivity_list),2)
        self.assertEqual(mss1.connectivity_list,[mssc1,
                                                 mssc2])
        self.assertEqual(mss1.states,['s1','s2','s3'])
        ## add a connectivity with a previously known state should not add it to the states
        mssc3 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s2',
                                                                    end_state='s4')
    ...
    def test_multistatescheme_eq(self):
        ...
        class MockObject(object):
            pass
        mssc1 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s1')
        mssc2 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s2')
        mssc3 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s3')
        mssc4 = ihm.multi_state_scheme.MultiStateSchemeConnectivity(begin_state='s1',
                                                                    end_state='s4')

        mss_ref = ihm.multi_state_scheme.MultiStateScheme(name='name1',
                                                       details='details1',
                                                       list_of_connectivities=[mssc1])
        mss_equal = ihm.multi_state_scheme.MultiStateScheme(name='name1',
                                                        details='details1',
                                                        list_of_connectivities=[mssc1])
        mss_unequal = ihm.multi_state_scheme.MultiStateScheme(name='name2',
                                                          details='details2',
                                                          list_of_connectivities=[mssc2])
        mss_unequal2 = ihm.multi_state_scheme.MultiStateScheme(name='name1',
                                                          details='details1',
                                                          list_of_connectivities=[mssc3])
        mss_unequal4 = ihm.multi_state_scheme.MultiStateScheme(name='name1',
                                                          details='details1',
                                                          list_of_connectivities=[mssc4])
        mss_unequal5 = ihm.multi_state_scheme.MultiStateScheme(name='name1',
                                                          details='details1',
                                                          list_of_connectivities=[mssc1],
    ...
    def test_kineticrate_init(self):
        ...
        k2 = ihm.multi_state_scheme.KineticRate(equilibrium_constant = 1.0,
        ...
        self.assertEqual(k3.equilibrium_constant_determination_method,'equilibrium constant is determined from population')
        ...
        ## Initialization with wrong equilibrium_constant_determination_method raises ValueError
        self.assertRaises(
            ValueError,
    ...
    def test_kineticrate_eq(self):
        ...
        k_unequal2 = ihm.multi_state_scheme.KineticRate(
            transition_rate_constant=1.0,
            equilibrium_constant=1.5,
            equilibrium_constant_determination_method='equilibrium constant is determined from kinetic rates, kAB/kBA',
            equilibrium_constant_unit="unit1",
            details="details1",
            dataset_group="dataset_group1",
            external_file="external_file1"
